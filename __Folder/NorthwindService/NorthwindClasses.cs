...
namespace Northwind
{	
	[DataContract] public partial class Product : SequencedObject
...
{
	[DataContract]
	public partial class Customer : SequencedObject
...
{
	[DataContract]
	public partial class Shipper : SequencedObject
...
{
	[DataContract]
	public partial class Supplier : SequencedObject
...
namespace Northwind
{	
	[DataContract] public partial class Order : SequencedObject
