...
namespace BusinessObjects
{
	...
	public static class WebHttpRequestClient
	{
		public static void CreateHttpWebRequest(Uri absoluteUri,			
			...
			WebMessageFormat responseFormat = WebMessageFormat.Json,
		...
		public static object SynchronousCall<TChannel,TResult>(Uri baseAddress, 
		    ...
		    {				
				...
				IEnumerable<Type> knownTypes = ExpressionSerialization.TypeSystem.GetBaseTypes(returnType);
				object[] parameters = getArguments(m);
		...
		/// <param name="m"></param>
		/// <returns></returns>
		static object[] getArguments(MethodCallExpression m)
		{
